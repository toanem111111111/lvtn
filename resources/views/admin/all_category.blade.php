      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><span class="text-ellipsis">
              <?php
                    if($cate_pro->status_category==0){
                        ?>
                <a href="{{URL::to('/unactive-category/'.$cate_pro->id_category)}}">
                    <span class="fa-thumb-styling fa fa-thumbs-down"></span></a>
                <?php
                    }else{
                        ?>
                 <a href="{{URL::to('/active-category/'.$cate_pro->id_category)}}">
            ...
            <td>
              <a href="{{URL::to('/edit-category/'.$cate_pro->id_category)}}" class="active styling-edit" ui-toggle-class="">
